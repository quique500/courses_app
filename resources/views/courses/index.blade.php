<x-app-layout>
    <section class="bg-cover" style="background-image: url({{asset('img/cursos/coding-gc6ebfa711_1920.jpg')}})">

        <div class="max-w-7xl mx-auto px-4 sm:px-60 lg:px-8 py-56">
            <div class="w-full md:w-3/4 lg:w-1/2">
                <h1 class="text-white font-fold text-5xl">Los mejores cursos de programación y desarrollo al alcance de tus manos. </h1>
