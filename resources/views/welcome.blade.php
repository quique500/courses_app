...
<x-app-layout>
    ...
    <section class="mt-24 bg-green-900 py-12">
        <h1 class="text-center text-white text-3xl">¿No saber qué curso llevar?</h1>
        ...
        <div class="flex justify-center mt-4">
            <button class="bg-gray-400 hover:bg-gray-800 text-white font-bold py-2 px-4 rounded">
                Catálogo de cursos
            </button>
        </div>
    </section>
